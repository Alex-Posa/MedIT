...
console.log(employeeDatabase.create("Lester Nygard", "nygard@fargo.com", "Bemidji Diner").toString());
employeeDatabase.create("Lorne Malvo", "lorne@fargo.com", "Bemidji Diner");
